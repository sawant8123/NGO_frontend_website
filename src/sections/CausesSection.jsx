export default function CausesSection() {
  ...
  const CauseCard = ({ title, description, image }) => (
    <div className="min-w-[18rem] max-w-[18rem] bg-white border border-gray-200 rounded-xl  overflow-hidden hover:scale-105 hover:shadow-md transition-all duration-300">
      ...
      <div className="p-4">
        <h3 className="text-lg font-bold text-ecoGreen">{title}</h3>
