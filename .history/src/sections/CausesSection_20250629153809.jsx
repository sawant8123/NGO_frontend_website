export default function CausesSection() {
  const causes = [
    { title: "Education", description: "Providing access to quality education for all.", image: "/images/Education.jpeg" },
    { title: "Health", description: "Organizing health camps and providing medical support.", image: "/images/Environment.jpg" },
    { title: "Women Empowerment", description: "Empowering women with skills and resources.", image: "public/images/nursing.jpg" },
  ];
