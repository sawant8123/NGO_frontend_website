    ...
    <section id="causes" className="py-20 bg-gradient-to-b from-orange-50 via-white to-orange-100">
      <div className="container mx-auto px-4">
        ...
        <div className="relative overflow-hidden">
          ...
          {/* Gradient overlays */}
          <div className="absolute inset-y-0 left-0 w-20  from-orange-100 to-transparent pointer-events-none z-10" />
          <div className="absolute inset-y-0 right-0 w-20  from-orange-100 to-transparent pointer-events-none z-10" />
        </div>
      </div>
    </section>
  );
