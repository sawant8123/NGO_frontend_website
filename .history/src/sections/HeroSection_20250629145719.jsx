...
export default function HeroSection() {
  return (
    <section className="h-screen bg-center bg-cover flex items-center justify-center text-white px-4" style={{ backgroundImage: "url('public/images/BANNER-33.jpg')" }}>
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="text-center">
        ...
        <a href="#donate" className="bg-red-600 hover:bg-red-700 px-6 py-3 rounded-lg text-white transition">Donate Now</a>
      </motion.div>
    </section>
  );
}
