export default function CausesSection() {
  ...
  const CauseCard = ({ title, description, image }) => (
    <div className="min-w-[18rem] max-w-[18rem] bg-white border border-gray-200 rounded-xl  overflow-hidden hover:scale-105 hover:shadow- transition-all duration-300">
